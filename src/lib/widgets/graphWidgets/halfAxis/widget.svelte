<script lang="ts">
    ...
    // Whether the Thing Cohort on this half-axis is expanded or collapsed.
    ...
    // Tweened version of `offsetToAlignToGrid`, for animation.
    ...
    // Tweened version of `thingOverlapMargin`, for animation.
